...
export default function AdminDashboard() {
  ...
  //       console.log("❌ Impossible de récupérer l'utilisateur connecté :", userError);
  //       return;
  //     }

  //     const currentUserId = userData.user.id;
  //     console.log("🧑‍💼 Utilisateur connecté :", currentUserId);
  //     console.log("👤 Client sélectionné :", selectedClient.id);
  ...
  //     console.log("📦 Buffer généré (taille) :", fileBuffer.byteLength);

  //     const path = `${selectedClient.id}/${name}`;
  //     console.log("🗂️ Chemin de stockage :", path);
  ...
  //     console.log("✅ Document inséré :", insertedRow);
  //     setDocuments((prev) => [insertedRow, ...prev]);
  //   } catch (error) {
  //     console.error("❌ Erreur traitement fichier :", error);
  //   }
