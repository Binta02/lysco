...
const CountrySelect = ({
  ...
  return (
    ...
    //   useNativeAndroidPickerStyle={false} // ← important pour Android
    //   // style={{
    //   //   inputIOS: {
    //   //     fontSize: 16,
    //   //     padding: 12,
    ...
    //       // assure que la zone tactile est complète
    //       borderWidth: 1,
    //       borderColor: "#5cb9bc",
    //       borderRadius: 8,
    //       padding: 12,
      ...
      <RNPickerSelect
        ...
        style={{
          ...
          viewContainer: {
            ...
            height: 50,
            justifyContent: "center",
            backgroundColor: "rgba(255,0,0,0.1)", // ← debug visual
          },
