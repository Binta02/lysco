...
const Checkout = () => {
  ...
  // const handleSubmit = async (data: FormValues) => {
  //   if (isProcessing) return; // ⛔ stop si déjà en cours

  //   setIsProcessing(true);
  //   console.log("🧪 handleSubmit lancé", isProcessing);
  ...
  //         if (lowerTitle.includes("morning") || lowerTitle.includes("matin")) {
  //           start = "09:00";
  //           end = "12:00";
  //           periodKey = "morning";
  //         } else if (
  //           lowerTitle.includes("afternoon") ||
  //           lowerTitle.includes("après-midi") ||
  //           lowerTitle.includes("apres-midi")
  //         ) {
  //           start = "13:00";
  //           end = "16:00";
  //           periodKey = "afternoon";
  ...
  //           start = times[0];
  //           end = `${String(parseInt(times[0].split(":")[0], 10) + 1).padStart(
  //             2,
  //             "0"
  //           )}:00`;
  //           periodKey = "morning";
  //         } else if (times.length > 1 && times[0] && times[times.length - 1]) {
  //           start = times[0];
  //           end = `${String(
  //             parseInt(times[times.length - 1].split(":")[0], 10) + 1
  //           ).padStart(2, "0")}:00`;
