        ...
        <View style={styles.assistantSection}>
          <View style={styles.assistantLeft}>
            ...
            <Text style={styles.assistantText}>
              ...
              <Text style={styles.bold}>essentiel</Text> de votre activité. Nos
              partenaires <Text style={styles.bold}>secrétaires</Text> prennent
              en charge toutes vos <Text style={styles.bold}>obligations</Text>,
              de la <Text style={styles.bold}>paperasserie quotidienne</Text> à
              la <Text style={styles.bold}>comptabilité</Text>, en passant par
              le <Text style={styles.bold}>suivi commercial</Text>. Ce service
              vous offre la <Text style={styles.bold}>liberté</Text> de vous
              consacrer pleinement à ce que vous faites de mieux, tout en ayant
              la <Text style={styles.bold}>tranquillité d’esprit</Text> que les
              aspects les plus <Text style={styles.bold}>fastidieux</Text> de
              votre entreprise sont{" "}
              <Text style={styles.bold}>gérés efficacement</Text> et{" "}
