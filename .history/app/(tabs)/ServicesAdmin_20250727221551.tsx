    ...
    <FlatList
      ListHeaderComponent={
        <>
          ...
          <AdminServiceOffers />
          <Text style={styles.paragraph}>{/* ton texte ici */}</Text>

          {/* Header de section Tarifs */}
          <View style={styles.section}>
            <View style={styles.container}>
              <View style={styles.header}>
                <Text style={styles.sectionTitle}>
      ...
      ListFooterComponent={
        <>
          {/* Assistanat + CTA + Footer */}
          <View style={styles.assistantSection}>
            {/* ... ton contenu assistanat ... */}
          </View>
          ...
          <View style={[styles.section, styles.gradientBox]}>
            ...
            <Text style={styles.paragraph}>Chez Lys&Co, nous offrons...</Text>
            <View style={styles.buttonRow}>
              <TouchableOpacity
                style={[styles.buttonPrimary, { backgroundColor: "#5cb9bc" }]}
                onPress={() => router.push("/(tabs)/Contact")}
