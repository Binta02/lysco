    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        <Text style={styles.paragraph}>
          Vous souhaitez améliorer votre prise de parole en public, que ce soit
          pour des présentations, des interviews ou des conférences ? Lys
        ...
        <View style={styles.list}>
          ...
          <Text style={styles.listItem}>
            • Exprimer votre perspective, en garantissant qu’elle soit comprise
            et appréciée à sa juste valeur.
          </Text>
        </View>

        <Text style={styles.paragraph}>
          Un oral se prépare pour communiquer clairement ! Nous vous apprendrons
          à gérer votre stress, bien communiquer oralement et travailler votre
          langage corporel.
        </Text>
