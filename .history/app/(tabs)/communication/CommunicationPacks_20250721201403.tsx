    ...
    >
      <View style={{ padding: 16 }}>
        ...
        <Text style={styles.intro}>
          ...
          conçus pour répondre à vos besoins en communication, tout en
          respectant votre budget. Chacun d’eux inclut un accompagnement
          stratégique et une flexibilité maximale dans les modalités de
          paiement.
        </Text>
