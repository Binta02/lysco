    ...
    >
      <View style={{ padding: 16 }}>
        ...
        <View style={[styles.section, styles.leftBorderPink]}>
          ...
          >
            {[
              "https://lys-conseil.com/wp-content/uploads/2024/03/photo-portrait-1.jpg",
              "https://lys-conseil.com/wp-content/uploads/2024/03/photo-portrait-2.jpg",
              "https://lys-conseil.com/wp-content/uploads/2024/03/photo-portrait-3.jpg",
            ].map((uri, i) => (
        ...
        <View style={[styles.section, styles.leftBorderTurquoise]}>
          ...
          >
            {[
              "https://lys-conseil.com/wp-content/uploads/2024/03/produit-1.jpg",
              "https://lys-conseil.com/wp-content/uploads/2024/03/produit-2.jpg",
              "https://lys-conseil.com/wp-content/uploads/2024/03/produit-3.jpg",
            ].map((uri, i) => (
              <View key={i} style={{ marginRight: 12 }}>
                <Image
                  source={{ uri }}
