    ...
    >
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.paragraph}>
          ...
          e-commerce (avec catalogue produit) ou un site vitrine. Tous nos sites
          sont <Text style={styles.bold}>responsive</Text> et conçus avec soin
          pour optimiser l’expérience utilisateur. Le contenu est pensé pour le
          référencement naturel afin d’être visible sur les moteurs de
          recherche.
        </Text>
      </View>
