    ...
    >
      ...
      <View style={styles.section}>
        <Text style={styles.paragraph}>
          ...
          <Text style={styles.bold}>Lys Conseil</Text>. Nous réalisons un audit
          pour déterminer ce qui ne convient pas et vous proposons un coaching
          personnalisé.
        </Text>
        <Text style={styles.paragraph}>
        ...
        <View style={styles.list}>
          <Text style={styles.listItem}>
            • L’organisation de votre temps de travail afin de pouvoir consacrer
            également du temps à vos proches
          </Text>
          <Text style={styles.listItem}>
