...
export default function ServiceDetailPage() {
  ...
  const getReservationPrice = () => {
    ...
    if (prices && reservationType in prices) {
      return prices[reservationType as keyof typeof prices] * quantity;
    }
    const handleAddToCart = () => {
      ...
      addItem({
        id: key,
        title: `${service.title} (${translateReservationType(
          reservationType
        )})`,
        price: totalPrice,
        quantity,
      ...
      toast({
        ...
        description: `${service.title} - ${translateReservationType(
          reservationType
        )} ajouté au panier.`,
      });
    };
