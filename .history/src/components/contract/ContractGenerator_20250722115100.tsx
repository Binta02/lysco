  ...
  const generateContractHtml = () => `
    <html>
      ...
      <body>
        ...
        <div class="card">
          <p><span class="bold">Société cliente :</span> ${data.companyName}</p>
          ...
          <p><span class="bold">Activité :</span> ${data.businessActivity}</p>
        </div>
        ...
        <div class="section">
          ...
          <p>Formule : <span class="bold">${data.planName}</span> – ${data.planPrice} €/mois.</p>
