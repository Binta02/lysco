      ...
      <body>
        ...
        <div class="page">
          <div class="card">
            ...
            <div class="text">
              Le Domiciliaire, en sa qualité d'entreprise agréée (n° préfectoral 04_95_2023) 
              conformément aux dispositions du Code du commerce et aux articles R.123-167 à R.123-168, 
              propose des services de domiciliation d'entreprise.
            </div>
            <div class="text">
