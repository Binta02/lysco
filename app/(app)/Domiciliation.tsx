      ...
      >
          ...
          <View style={styles.cardRow}>
            <View style={styles.featureCard}>
              <View style={[styles.iconCircle, { backgroundColor: "#ccfbf1" }]}>
                <MaterialIcons name="place" size={24} color="#5cb9bc" />
              </View>
            ...
            <View style={styles.featureCard}>
              <View style={[styles.iconCircle, { backgroundColor: "#ccfbf1" }]}>
                <MaterialIcons name="verified-user" size={24} color="#5cb9bc" />
              </View>
        ...
        <View style={{ paddingHorizontal: 16, paddingVertical: 24 }}>
          ...
          <View style={styles.whiteBox}>
            <Text style={styles.cardTitle}>
              {/* <Ionicons name="checkmark-circle" size={20} color="#5cb9bc" />{" "} */}
          ...
          >
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                router.push("/(app)/services/pack-domicilie");
              }}
            >
        ...
        <View style={{ marginTop: 48, alignItems: "center", marginBottom: 40 }}>
          ...
          <View style={styles.buttonRow}>
            ...
            <TouchableOpacity
              ...
              onPress={() => router.push("/(app)/Tarifs" as any)}
            >
        ...
        <View style={{ marginBottom: 32, padding: 16 }}>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push(`/(app)/EspacesTravail` as any)}
          >
            <Text style={styles.primaryButtonText}>
