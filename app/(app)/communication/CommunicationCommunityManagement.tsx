      ...
      <View style={{ padding: 16 }}>
        ...
        <View style={styles.textBlock}>
          <Text style={styles.paragraph}>
            Notre agence de communication 360° vous aide à bâtir et à fédérer
            une communauté engagée autour de votre marque. Votre présence sur
            les réseaux sociaux devient un véritable levier de fidélisation.
          </Text>
          <Text style={styles.paragraph}>
            Notre équipe de community managers tisse des liens solides avec
            votre audience. Nous créons du contenu pertinent et engageant,
            répondons aux commentaires et messages, et gérons les échanges sur
            toutes vos plateformes.
          </Text>
          <Text style={styles.paragraph}>
            Nous assurons une veille concurrentielle constante pour vous
            proposer des actions pertinentes, des campagnes créatives et une
            gestion de crise en cas de besoin.
          </Text>
          <Text style={styles.paragraph}>
            Vos campagnes sont analysées avec des outils puissants afin de
            mesurer les performances et ajuster les actions pour des résultats
            toujours meilleurs.
          </Text>
        </View>
